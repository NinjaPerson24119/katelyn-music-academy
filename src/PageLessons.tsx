  ...
  return (
    <div className="flex flex-col items-center md:flex-row md:items-start">
      <div className="w-full md:w-1/2 p-4">
        <h1 className="text-accent">{t('LESSONS.TITLE')}</h1>
        <p>
      ...
      <div className="w-full md:w-1/2 p-4 flex flex-col gap-2">
        {[
          [
            ...
            t('LESSONS.LESSON_LENGTH_30_MINUTES_CONTENT'),
          ],
          [
            t('LESSONS.LESSON_LENGTH_45_MINUTES'),
            t('LESSONS.LESSON_LENGTH_45_MINUTES_CONTENT'),
          ],
          [
            t('LESSONS.LESSON_LENGTH_60_MINUTES'),
            t('LESSONS.LESSON_LENGTH_60_MINUTES_CONTENT'),
          ],
        ].map(([title, content], index) => (
          <div
            key={index}
            className="collapse collapse-plus bg-none border border-base-400"
          >
            <input
              type="radio"
              name="lessons-accordion"
